...
namespace DesignPatternsC_
{
	class Program
	{
		...
		public static void DemoObserverSystem()
		{
			LocationTracker locationTracker = new LocationTracker();

			LocationReporter reporter1 = new LocationReporter("reporter 1");
			LocationReporter reporter2 = new LocationReporter("reporter 2");
			LocationReporter reporter3 = new LocationReporter("reporter 3");
			LocationReporter reporter4 = new LocationReporter("reporter 4");

			reporter1.Subscribe(locationTracker);
			reporter2.Subscribe(locationTracker);
            reporter3.Subscribe(locationTracker);
            reporter4.Subscribe(locationTracker);
			locationTracker.DoSomething();
			locationTracker.Flee();
		}
